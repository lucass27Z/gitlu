  ...
  return (
    ...
    >
      ...
      <TabsPrimitive.Indicator
        className={cn(
          "shadow-[0px_0px_2px_0px_#00000020]! -translate-y-(--active-tab-bottom) absolute bottom-0 left-0 h-(--active-tab-height) w-(--active-tab-width) translate-x-(--active-tab-left) transition-[width,translate] duration-200 ease-in-out",
          variant === "underline"
